...
강점은 RAG/LLM 응용, 한국어 텍스트 처리, 예측·추천, 시뮬레이션 기반 의사결정이며
...
- `lop진단 → 시뮬레이션 → 결과 리포트` 파이프라인으로 실행 전략 제공
...
- [AiRPA 및 기타 프로젝트 → Portfolio](https://cofldus.github.io/)
...
**성신여자대학교** · AI융합학부 · GPA **3.94** / 4.50 · 전공 **4.05** · 2021.03 – 2026.08 졸업예정
...
| 과정 | 기관 | 기간 | 주요 내용 |
|---|---|---|---|
| AI 자연어처리 엔지니어 과정 | 멋쟁이사자처럼 | 2025.12 – 2026.02 | AI Agent · LLM 파인튜닝 · RAG 시스템 구축 (343h) |
| 청년 AI·Bigdata 아카데미 | 포스코 | 2025.06 – 2025.08 | LLM · RAG · 데이터 분석 기반 모델 설계 (424h) |
| LG Aimers 4기 | LG AI연구원 | 2024.01 – 2024.02 | B2B 영업 기회 창출 예측 모델 개발 |
| LG Aimers 2기 | LG AI연구원 | 2023.01 – 2023.02 | 스마트 공장 품질 상태 분류 |
| Microsoft 정보보안과정 | Microsoft · 고용노동부 | 2023.10 | 클라우드 기반 정보보안 기초 |
| 학생창업경진대회 A등급 수료 | 교육부 · 연세대학교 창업지원단 | 2022.07 – 2022.08 | 기술의 비즈니스 구조화 경험 |
...
| 수상 | 주관 | 일자 | 프로젝트 |
|---|---|---|---|
| 장려상 | 포스코 인재창조원 | 2025.08 | KillKong — 콩글리쉬 교정 AI Agent |
| 특별상 | 한국지능정보사회진흥원 | 2023.11 | AiRPA 해커톤 — RPA+LLM 진로 탐색 자동화 |
| 장려상 | 성신여자대학교 | 2023.09 | 눈치게임 — 혼잡도 예측·추천 서비스 |
